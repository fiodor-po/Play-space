...
- It follows the repo constraints from `AGENTS.md` and the required structure from `docs/00_AGENT_OS/PLANS.md`.
- `docs/01_CURRENT_STATE/ROADMAP.md` is the live project-plan, backlog, and decision-log document; this file remains architecture-specific.
