...
- `docs/01_CURRENT_STATE/ROADMAP.md` for live priorities and chapter order;
- `docs/00_AGENT_OS/CURRENT_CONTEXT.md` for operational handoff state;
- `docs/04_ARCHITECTURE/02_DATA_AND_SYNC/room-document-replica-map.md` for the human-facing control map of the
...
`docs/01_CURRENT_STATE/ROADMAP.md` remains the live project-plan and priority source.
...
This plan supports the active `docs/01_CURRENT_STATE/ROADMAP.md` phase by turning the completed
