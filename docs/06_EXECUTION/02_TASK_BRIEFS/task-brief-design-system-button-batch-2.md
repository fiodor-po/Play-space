...
- `docs/06_EXECUTION/01_EXECPLANS/execplan-design-system-ordinary-interface-migration.md`
- `docs/06_EXECUTION/02_TASK_BRIEFS/task-brief-design-system-button-family-first-slice.md`
- `docs/06_EXECUTION/02_TASK_BRIEFS/task-brief-design-system-dice-button-subtype-slice.md`

## Files to inspect first

- `docs/03_PRODUCT/03_INTERFACE_SYSTEM/02_CANON/CANONICAL.md`
- `docs/03_PRODUCT/03_INTERFACE_SYSTEM/03_ROLLOUT/MIGRATION_MAP.md`
- `docs/06_EXECUTION/02_TASK_BRIEFS/task-brief-design-system-button-batch-2.md`
