...
- Onboarding and repo entry are genuinely better now.
  Evidence: `README.md`, `docs/README.md`, `docs/EXECUTOR_QUICKSTART.md`, and `docs/ARCHITECTURE.md` now exist and route a fresh reader correctly. This directly closes the biggest onboarding weakness from the earlier audits.
...
- The roadmap itself has moved from generic hygiene toward `App` structural analysis.
  Evidence: `ROADMAP.md` now frames the active phase as a repo/runtime health pass centered on `src/App.tsx`.
