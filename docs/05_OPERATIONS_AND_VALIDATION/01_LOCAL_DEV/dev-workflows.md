...
`docs/05_OPERATIONS_AND_VALIDATION/01_LOCAL_DEV/livekit-local-dev.md` остаётся дополнительным deep-dive note про underlying LiveKit setup и troubleshooting.
