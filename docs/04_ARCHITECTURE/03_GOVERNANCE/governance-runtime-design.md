...
- canonical future policy matrices belong in `docs/04_ARCHITECTURE/03_GOVERNANCE/governance-model-design.md`.
...
- image creator may clear all drawing on their own image
- room creator may clear all drawing on any image in that room
- other participants may not clear all drawing on someone else's image
...
1. keep `docs/04_ARCHITECTURE/03_GOVERNANCE/governance-model-design.md` as the source of governance logic/policy structure
...
- update `docs/04_ARCHITECTURE/03_GOVERNANCE/governance-model-design.md`
