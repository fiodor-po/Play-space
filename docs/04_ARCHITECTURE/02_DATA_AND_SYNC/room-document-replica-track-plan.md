...
- `docs/04_ARCHITECTURE/02_DATA_AND_SYNC/room-document-persistence-target-memo.md` как technical target;
- `docs/04_ARCHITECTURE/02_DATA_AND_SYNC/room-document-replica-map.md` как human-facing control map;
- `docs/01_CURRENT_STATE/ROADMAP.md` как общий live priority source;
- `docs/00_AGENT_OS/CURRENT_CONTEXT.md` как operational handoff state.

При конфликте:

1. `docs/04_ARCHITECTURE/02_DATA_AND_SYNC/room-document-persistence-target-memo.md`
2. `docs/04_ARCHITECTURE/02_DATA_AND_SYNC/room-document-replica-map.md`
3. `docs/01_CURRENT_STATE/ROADMAP.md`
4. этот файл
...
- review open entries in `docs/01_CURRENT_STATE/REVIEW_FOLLOWUPS.md`, которые затронуты этим
  step;
...
- if a new task or chapter is spawned, update `docs/01_CURRENT_STATE/ROADMAP.md` and
  `docs/00_AGENT_OS/CURRENT_CONTEXT.md` in the same pass.
...
6. обновить `docs/01_CURRENT_STATE/ROADMAP.md` и `docs/00_AGENT_OS/CURRENT_CONTEXT.md` после
