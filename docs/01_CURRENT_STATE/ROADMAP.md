...
Для крупных многошаговых задач используются `docs/00_AGENT_OS/PLANS.md` и отдельные ExecPlan-документы.

## 2. Как этот документ соотносится с другими

- `AGENTS.md` — общие рабочие правила для Codex / агентов.
- `docs/00_AGENT_OS/PLANS.md` — шаблон и требования к ExecPlan.
- `docs/03_PRODUCT/00_OVERVIEW/PRODUCT_FOUNDATION.md` — стабильная продуктовая и архитектурная рамка.
- `docs/00_AGENT_OS/CURRENT_CONTEXT.md` — handoff и текущий рабочий контекст между чатами.
- `docs/02_DECISIONS_LOG/CASE_STUDY_LOG.md` — накопительный журнал решений, багов, milestones и workflow lessons.
- `docs/90_ARCHIVE/02_HISTORICAL_BASELINE/refactor-audit.md` и `docs/90_ARCHIVE/02_HISTORICAL_BASELINE/refactor-plan.md` — historical architecture baseline.
- `docs/01_CURRENT_STATE/ROADMAP.md` — живая карта этапов, приоритетов, backlog и open questions.
...
- большие планы держать отдельно в `docs/00_AGENT_OS/PLANS.md` / ExecPlan;
